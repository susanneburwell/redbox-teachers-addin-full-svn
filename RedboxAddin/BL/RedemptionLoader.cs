        ...
        private static IUnknown NewRedemptionObject(Guid guid)
        {
            ...
            if (_redemptionDllHandle.Equals(IntPtr.Zero))
            {
                ...
                if (IntPtr.Size == 8)
                {
                    ...
                    Debug.DebugMessage(4, "Redemption : Used Redemption 64 Bit version.");
                }
                else
                {
                    dllPath = DllLocation32Bit;
                    Debug.DebugMessage(4, "Redemption : Used Redemption 32 Bit version.");
                }
                ...
                if (_dllGetClassObjectPtr.Equals(IntPtr.Zero)) throw new Exception("Could not retrieve a pointer to the 'DllGetClassObject' function exported by the dll");
