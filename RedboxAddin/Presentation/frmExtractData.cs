    ...
    public partial class frmExtractData : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in oItems)
            {
                ...
                contactObj.AdditionalInfoOnCRB = CheckBool(GetOProp("Additional Info on CRB", ref oProps));
                ...
                contactObj.CRBandAddressProofMatch = CheckBool(GetOProp("CRB & Proof of Address match", ref oProps));
                contactObj.CRBDateSent = CheckDate(GetOProp("CRB Date Sent", ref oProps));
                contactObj.CRBExpiryDate = CheckDate(GetOProp("CRB Expiry Date", ref oProps));
                contactObj.CRBFormRef = GetOProp("CRB Form Ref", ref oProps);
                contactObj.CRBNumber = GetOProp("CRB Number", ref oProps);
                contactObj.CRBValidFrom = CheckDate(GetOProp("CRB Valid From", ref oProps));
                ...
                contactObj.RedboxCRB = CheckBool(GetOProp("RedBoxCRB", ref oProps));
